...
namespace Mtconnect.AdapterSdk.DataItemValues
{
	...
	public partial class Orientation : Sample3DValue
    {
        /// <inheritdoc />
        public override string ObservationalType => nameof(DataItemTypes.SampleTypes.ORIENTATION);
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.OrientationSubTypes.ACTUAL);
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.OrientationSubTypes.COMMANDED);

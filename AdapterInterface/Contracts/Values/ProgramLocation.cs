...
namespace Mtconnect.AdapterInterface.DataItemValues
{
	...
	public partial class ProgramLocation : EventValue
    {
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.ProgramLocationSubTypes._SCHEDULE);
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.ProgramLocationSubTypes._MAIN);
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.ProgramLocationSubTypes._ACTIVE);

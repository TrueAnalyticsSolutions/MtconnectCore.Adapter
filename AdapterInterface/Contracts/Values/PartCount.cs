...
{
	/// <summary>
	/// A value type for PartCount to be used in a <see cref="IAdapterDataModel" /> implementation. View in the MTConnect Model browser <seealso href="https://model.mtconnect.org/#Enumeration__">model.mtconnect.org</seealso>
	﻿	/// </summary>
	...
	public partial class PartCount : EventValue
    {
		...
		/// </summary>
        public PartCount(string value) : base(value) { }

		
        /// <summary>
        /// Implicitly converts the specified string to an <see cref="PartCount"/> value.
        /// The string is converted to uppercase and used to initialize the <see cref="PartCount"/> value.
        /// </summary>
        /// <param name="value">The string to convert.</param>
        /// <returns>An <see cref="PartCount"/> value initialized with the specified string in uppercase.</returns>
        public static implicit operator PartCount(string value)
        {
            return new PartCount(value.ToUpperInvariant());
        }

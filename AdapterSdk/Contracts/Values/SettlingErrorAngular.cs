...
namespace Mtconnect.AdapterSdk.DataItemValues
{
    ...
    {
        /// <inheritdoc />
        public override string ObservationalType => nameof(DataItemTypes.SampleTypes.SETTLING_ERROR_ANGULAR);
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.SettlingErrorAngularSubTypes.ACTUAL);

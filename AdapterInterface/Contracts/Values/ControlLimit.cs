...
{
	/// <summary>
	/// A value type for ControlLimit to be used in a <see cref="IAdapterDataModel" /> implementation. View in the MTConnect Model browser <seealso href="https://model.mtconnect.org/#Enumeration__">model.mtconnect.org</seealso>
	﻿	/// </summary>
	...
	public partial class ControlLimit : EventValue
    {
        ...
        {
            return new ControlLimit(value.ToUpperInvariant());
        }

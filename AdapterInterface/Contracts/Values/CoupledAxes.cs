...
{
	/// <summary>
	/// A value type for CoupledAxes to be used in a <see cref="IAdapterDataModel" /> implementation. View in the MTConnect Model browser <seealso href="https://model.mtconnect.org/#Enumeration__">model.mtconnect.org</seealso>
	﻿	/// </summary>
	...
	public partial class CoupledAxes : EventValue
    {
        ...
        {
            return new CoupledAxes(value.ToUpperInvariant());
        }

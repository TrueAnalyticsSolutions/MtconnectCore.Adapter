...
namespace Mtconnect.AdapterInterface.DataItemValues
{
    ...
    {
        /// <inheritdoc />
        public override string ObservationalType => nameof(DataItemTypes.SampleTypes.CHARGE_RATE);
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.ChargeRateSubTypes.ACTUAL);
		...
		{
			/// <inheritdoc />
            public override string ObservationalSubType => nameof(DataItemTypes.ChargeRateSubTypes.TARGET);
